...
function buildEmbeddingConfig(overrides = {}) {
    ...
    if (!openAIApiKey) {
        throw new Error('Embedding API key is not configured. Set EMBEDDING_NG_API_KEY (or the compatible EMBEDDING_API_KEY) in your .env file or pass it in overrides.');
    }
